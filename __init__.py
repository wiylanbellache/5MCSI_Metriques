...
import sqlite3
import requests  # Pour appeler l'API de GitHub
from collections import Counter  # Pour compter les commits par minute
import matplotlib.pyplot as plt  # Pour générer des graphiques
import io  # Pour convertir le graphique en réponse HTTP
import base64  # Pour encoder l'image en base64
